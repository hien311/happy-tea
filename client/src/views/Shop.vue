    ...
    <div class="shop-content">
      ...
      <div class="filter-result">
        ...
        <div v-else class="filter-result-body">
          <div class="card" v-for="product in filterResult" :key="product.id" :data-id="product.id" :data-catalog="product.categoryId" @click="goDetailPage">
            <div class="card-body">
...
import { FETCH_BRAND } from '../store/actions.type'
export default {
  name: 'shop',
  mixins: [methodMixin],
  data() {
